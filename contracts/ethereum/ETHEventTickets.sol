...
contract ETHEventTickets is ERC721Enumerable, Ownable {
  ...
  constructor(address _marketplaceContract) ERC721("ETHEventTickets", "FXC22") {
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    ...
    bytes memory collectionJsonString = bytes(abi.encodePacked(
      '{"name": "ETHEventTickets",',
      '"description": "ETHEventTickets is the most premier fox event in the solar system this year. Join friends from all over the world this December as the skulk descend on the Web3 space and dig their paws into everything Ethereum. Stay foxy, your NFT purchase is your ticket to the event!",', 
  ...
  function mint() public payable canMint returns (uint256) {
  ...
  function tokenURI(uint256 id) public view override returns (string memory) {
    ...
    string memory description = string(abi.encodePacked((vipTicketHolders[id] ? "VIP" : "General Admission"), ' access to ETHEventTickets on DATE_OF_EVENT.'));
  ...
  function renderNftSvgTopById(uint256 id) internal view returns (string memory) {
    return string(abi.encodePacked(
      ...
      '<g transform="matrix(1,0,0,1,0,0.177859)"><path d="M295,199.822L5,199.822L5,284.988C5,290.416 9.406,294.822 14.834,294.822L285.166,294.822C290.594,294.822 295,290.416 295,284.988L295,199.822Z" style="fill:rgb(76,76,76);"/></g>',
      '<g id="eventMessage" transform="matrix(1.6679,0,0,1.6679,-20.8417,86.6168)"><text x="24.056px" y="53.979px" style="font-family:''ArialMT'', ''Arial'', sans-serif;font-size:9.593px;">See you in x Days!</text></g>',
      '<g id="cancelled" transform="matrix(1.6679,0,0,1.6679,-20.6542,-25.266)"><text x="24.056px" y="53.979px" style="font-family:''ArialMT'', ''Arial'', sans-serif;font-size:6.395px;fill:rgb(215,43,123);">CANCELLED</text></g>',
      '<g id="eventDate" transform="matrix(1.6679,0,0,1.6679,-20.606,-38.5316)"><text x="24.056px" y="53.979px" style="font-family:''ArialMT'', ''Arial'', sans-serif;font-size:9.593px;">2022, Nov 18</text></g>',
      '<g id="eventName" transform="matrix(1.6679,0,0,1.6679,-21.8104,-54.7608)"><text x="24.056px" y="53.979px" style="font-family:''ArialMT'', ''Arial'', sans-serif;font-size:12.791px;">ETH Atlantis</text></g>'
    ));
  }
  function renderNftSvgBottomById(uint256 id) internal view returns (string memory) {
    ...
    return string(abi.encodePacked(
      ...
      '<g transform="matrix(0.966539,0,0,0.966539,4.93126,4.90586)"><path d="M0.071,201.848L300.111,201.848L300.111,10.272C300.111,4.656 295.552,0.097 289.936,0.097L10.245,0.097C4.63,0.097 0.071,4.656 0.071,10.272L0.071,201.848Z" style="fill:rgb(194,194,194);"/></g>',
      '<g id="ticketType" transform="matrix(1.6679,0,0,1.6679,51.5802,191.5)"><text x="5.566px" y="53.979px" style="font-family:''ArialMT'', ''Arial'', sans-serif;font-size:12.791px;fill:white;">General Admission</text></g>',
      '<g id="ticketNumber" transform="matrix(1.6679,0,0,1.6679,51.9249,163.089)"><text x="25.898px" y="53.979px" style="font-family:''ArialMT'', ''Arial'', sans-serif;font-size:23.982px;fill:white;">#0000</text></g>'
    ));
  }
